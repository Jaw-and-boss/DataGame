...
[ExecuteInEditMode]
public class NewMeshCollider : MonoBehaviour
{
    private bool mergeBoxesToReduceNumber = true;
    private int spatialTreeLevelDepth = 0;
    ...
    public void Calculate()
    {
        ...
        try
        {
            ...
            //Debug.Log("NewConvexMeshCollider: " + mergedBoxes.Length + " box colliders created");
...
[CustomEditor(typeof(NewMeshCollider))]
public class NewMeshColliderEditor : Editor
{
    public override void OnInspectorGUI()
    {
        DrawDefaultInspector();

        var scripts = targets.OfType<NewMeshCollider>();
